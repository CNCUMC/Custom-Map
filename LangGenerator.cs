...
internal class LangGenerator : ModLangGenMultiBase
{
    ...
    protected override void BuildLocaleData()
    {
        ...
        Option("custommap.first_use_map",
        ...
        Option("custommap.progress_update_interval",
        ...
        Other("feature.climb_limit",
            ...
            "攀爬極限",
            "Лимит взбирания");
        Other("feature.world_settings_data",
            "World Settings",
            "世界设置",
            "世界設置",
            "Настройки мира");
        ...
        Other("feature.skip_background",
            ...
            "跳過背景",
            "Пропустить фон");
        Other("feature.mine_data",
            "Mine",
            "地雷",
            "地雷",
            "Мина");
        Other("feature.jump_pad_data",
            "Jump Pad",
            "弹跳板",
            "彈跳板",
            "Прыжковая платформа");
        Other("feature.turret_data",
            "Turret",
            "炮塔",
            "炮塔",
            "Турель");
        Other("feature.sound_cannon_data",
            "Sound Cannon",
            "音波炮",
            "音波炮",
            "Звуковая пушка");
        Other("feature.spike_stabber_data",
            "Spike Stabber",
            "尖刺陷阱",
            "尖刺陷阱",
            "Шипастый ударник");
        Other("feature.geyser_data",
            "Geyser",
            "间歇泉",
            "間歇泉",
            "Гейзер");
        Other("feature.beartrap_data",
            "Bear Trap",
            "捕兽夹",
            "捕獸夾",
            "Медвежий капкан");
        Other("feature.xp_data",
            "XP",
            "经验值",
            "經驗值",
            "Опыт");
        ...
        // Command - Map
        Command("custommap.description",
            "Map related commands",
            "地图的相关指令",
            "地圖的相關指令",
            "Команды карты");
        Command("custommap.string",
            "Select function",
            "选择功能",
            "選擇功能",
            "Выбрать функцию");
        Command("custommap.parameter",
            "Function parameter",
            "功能参数",
            "功能參數",
            "Параметр функции");
        Command("custommap.help.header",
            "Available subcommands:",
            "可用子命令:",
            "可用子命令:",
            "Доступные подкоманды:");
        Command("custommap.help.help",
            "Show this help message",
            "显示此帮助信息",
            "顯示此幫助訊息",
            "Показать это справочное сообщение");
        Command("custommap.help.reload",
            "Reload current map",
            "重新加载当前地图",
            "重新載入當前地圖",
            "Перезагрузить текущую карту");
        Command("custommap.help.load",
            "Reload Maps folder",
            "重新加载 Maps 文件夹",
            "重新載入 Maps 資料夾",
            "Перезагрузить папку Maps");
        Command("custommap.help.savereload",
            "Save and reload current map",
            "保存并重新加载当前地图",
            "保存並重新載入當前地圖",
            "Сохранить и перезагрузить текущую карту");
        Command("custommap.load.success",
            "Maps reloaded successfully",
            "地图重新加载成功",
            "地圖重新載入成功",
            "Карты успешно перезагружены");
        Command("custommap.help.info",
            "Show map info",
            "显示地图信息",
            "顯示地圖資訊",
            "Показать информацию о карте");
        Command("custommap.help.spawn",
            "Teleport to spawn",
            "传送回出生点",
            "傳送回出生點",
            "Телепортация на спавн");
        Command("custommap.help.select",
            "Select a Map",
            "选择地图",
            "選擇地圖",
            "Выбрать карту");
        Command("custommap.help.list",
            "List all Maps",
            "列出所有地图",
            "列出所有地圖",
            "Список всех карт");
        Command("custommap.help.feature",
            "Manage features",
            "管理特性",
            "管理特性",
            "Управление особенностями");
        Command("custommap.help.waypoint",
            "Manage waypoints (list/get)",
            "管理路径点 (list/get)",
            "管理路徑點 (list/get)",
            "Управление путевыми точками (list/get)");
        Command("custommap.help.save",
            "Save current Map",
            "保存当前地图",
            "保存當前地圖",
            "Сохранить текущую карту");
        Command("custommap.help.level",
            "Switch map level",
            "切换地图层级",
            "切換地圖層級",
            "Переключить уровень карты");
        Command("custommap.help.exit",
            "Exit Map",
            "退出地图",
            "退出地圖",
            "Выйти с карты");
        ...
        // Command - Map - Info
        Command("custommap.info.name",
            "Name: '{0}'",
            "名称: '{0}'",
            "名稱: '{0}'",
            "Имя: '{0}'");
        Command("custommap.info.id",
            "ID: '{0}'",
            "ID: '{0}'",
            "ID: '{0}'",
            "ID: '{0}'");
        Command("custommap.info.version",
            "Version: '{0}'",
            "版本: '{0}'",
            "版本: '{0}'",
            "Версия: '{0}'");
        Command("custommap.info.authors",
            "Authors: '{0}'",
            "作者: '{0}'",
            "作者: '{0}'",
            "Авторы: '{0}'");
        Command("custommap.info.description",
            "Description: '{0}'",
            "描述: '{0}'",
            "描述: '{0}'",
            "Описание: '{0}'");
        Command("custommap.info.features",
            "Features: '{0}'",
            "特性: '{0}'",
            "特性: '{0}'",
            "Особенности: '{0}'");
        Command("custommap.info.spawn",
            "Spawn point: '{0}'",
            "出生点: '{0}'",
            "出生點: '{0}'",
            "Точка спавна: '{0}'");
        ...
        Command("custommap.waypoint.help",
        ...
        Command("custommap.waypoint.list_header",
            "Available waypoints ({0}):",
            "可用路径点 ({0}):",
            "可用路徑點 ({0}):",
            "Доступные путевые точки ({0}):");
        Command("custommap.waypoint.list_item",
            "  {0}. {1} - Position: {2}",
            "  {0}. {1} - 位置: {2}",
            "  {0}. {1} - 位置: {2}",
            "  {0}. {1} - Позиция: {2}");
        Command("custommap.waypoint.teleport",
        ...
        Command("custommap.waypoint.get_no_id",
        ...
        // Command - Map - Select
        Command("custommap.select.no_key",
        ...
        Command("custommap.select.invalid_index",
            "Invalid index {0}, please enter a number between 1 and {1}",
            "无效的索引 '{0}'，请输入 1 到 {1} 之间的数字",
            "無效的索引 '{0}'，請輸入 1 到 {1} 之間的數字",
            "Неверный индекс {0}, введите число от 1 до {1}");
        ...
        // Command - Map - Layer
        Command("custommap.layer.current",
            "Current layer: {0}/{1}",
            "当前层级: {0}/{1}",
            "當前層級: {0}/{1}",
            "Текущий слой: {0}/{1}");
        ...
        Command("custommap.exiting",
            ...
            "正在返回{0}...",
            "Возврат к {0}...");
        Command("custommap.exit.invalid_target",
        ...
        Command("custommap.exit.target.none",
            "vanilla game",
            "原版游戏",
            "原版遊戲",
            "ванильная игра");
        Command("custommap.exit.target.tutorial",
            "tutorial",
            "教程",
            "教程",
            "туториал");
        ...
        // Command - Map - Save
        Command("custommap.save.success",
            "Map '{0}' saved to: {1}",
            "已将地图 '{0}' 保存到: '{1}'",
            "已將地圖 '{0}' 保存到: '{1}'",
            "Карта '{0}' сохранена в: {1}");
        Command("custommap.save.failed",
            "Failed to save Map '{0}': {1}",
            "保存地图 '{0}' 失败: '{1}'",
            "保存地圖 '{0}' 失敗: '{1}'",
            "Не удалось сохранить карту '{0}': {1}");
        Command("custommap.save.no_directory",
        ...
        Command("custommap.save.target_not_found",
        ...
        Command("custommap.feature.list_header",
            "Current feature settings:",
            "当前特性设置: ",
            "當前特性設定: ",
            "Текущие настройки особенностей:");
        Command("custommap.feature.get_success",
            "Feature '{0}' = {1}",
            "特性 '{0}' = '{1}'",
            "特性 '{0}' = '{1}'",
            "Особенность '{0}' = {1}");
        Command("custommap.feature.set_success",
            "Feature '{0}' set to {1}",
            "特性 '{0}' 已设置为 '{1}'",
            "特性 '{0}' 已設置為 '{1}'",
        ...
        Log("map_check.id_format_warning",
            "ID format is incorrect, will be automatically corrected",
            "ID格式不正确，将自动修正",
            "ID格式不正確，將自動修正",
        ...
        Log("map_check.author_empty",
            ...
            "作者数组为空，已设置默认值",
            "作者陣列為空，已設置預設值",
            "Массив авторов пуст, установлено значение по умолчанию");
        Log("map_check.version_format_warning",
            "Version format '{0}' is incorrect, will use default version '1.0.0'",
            "版本格式 '{0}' 不正确，将使用默认版本 '1.0.0'",
            "版本格式 '{0}' 不正確，將使用預設版本 '1.0.0'",
            "Формат версии '{0}' неверен, будет использоваться версия по умолчанию '1.0.0'");
        Log("map_check.missing_build_mode_mod",
            "Map '{0}' requires Build Mode mod but it is not installed",
            "地图 '{0}' 需要 Build Mode 模组，但未安装",
            "地圖 '{0}' 需要 Build Mode 模組，但未安裝",
            "Карта '{0}' требует мод Build Mode, но он не установлен");
        Log("map_check.requires_mod",
            "[requires {0}]",
            "[需要 {0}]",
            "[需要 {0}]",
            "[требуется {0}]");
        ...
        Log("world_generation.applying_settings_overrides",
        ...
        Log("map_loader.load_error",
            ...
            "地图或地图数据为空",
            "地圖或地圖資料為空",
            "Карта или данные карты пусты");
        Log("map_loader.invalid_format",
            "Invalid map format, missing map field",
            "无效的地图格式，缺少 map 字段",
            "無效的地圖格式，缺少 map 欄位",
            "Неверный формат карты, отсутствует поле map");
        Log("map_loader.key_missing",
            "Error: String map format missing 'key' definition",
            "错误: 字符串地图格式缺少 'key' 定义",
            "錯誤: 字串地圖格式缺少 'key' 定義",
            "Ошибка: В формате строковой карты отсутствует определение 'key'");
        Log("map_loader.string_map_applied",
            "String map applied, {0} successes, {1} failures",
            "字符串地图已应用，{0} 成功，{1} 失败",
            "字串地圖已應用，{0} 成功，{1} 失敗",
            "Строковая карта применена, {0} успешно, {1} неудачно");
        ...
        Log("map_loader.place_failed",
            ...
            "在 ({0}, {1}) 放置 {2} {3} 失败: {4}",
            "在 ({0}, {1}) 放置 {2} {3} 失敗: {4}",
            "Не удалось разместить {2} {3} в ({0}, {1}): {4}");
        Log("map_loader.multiple_blocks_in_list",
            "Multiple blocks detected in list at ({0}, {1}), only the first one will be generated",
            "在 ({0}, {1}) 检测到多个方块，只会生成第一个",
            "在 ({0}, {1}) 檢測到多個方塊，只會生成第一個",
            "В списке в ({0}, {1}) обнаружено несколько блоков, будет сгенерирован только первый");
        Log("map_loader.unsupported_value_type",
            "Unsupported value type: {0}, position ({1}, {2})",
            "不支持的值类型: '{0}'，位置 ({1}, {2})",
            "不支援的值類型: '{0}'，位置 ({1}, {2})",
            "Неподдерживаемый тип значения: {0}, позиция ({1}, {2})");
        Log("map_loader.nested_structure_not_supported",
            "Nested structure not supported, position ({0}, {1})",
            "不支持嵌套结构，位置 ({0}, {1})",
            "不支援巢狀結構，位置 ({0}, {1})",
            "Вложенные структуры не поддерживаются, позиция ({0}, {1})");
        Log("map_loader.unexpected_token_type",
            "Unexpected token type: {0}, position ({1}, {2})",
            "意外的令牌类型: '{0}'，位置 ({1}, {2})",
            "非預期的權杖類型: '{0}'，位置 ({1}, {2})",
        ...
        Log("error.multiple_content_types",
            ...
            "地图 '{0}' 定义了多种内容类型 (Structures, BuildModeSave)。只允许一种类型。",
            "地圖 '{0}' 定義了多種內容類型 (Structures, BuildModeSave)。只有一種類型被允許。",
            "Карта '{0}' имеет несколько определенных типов содержимого (Structures, BuildModeSave). Разрешен только один тип.");
        ...
        Log("common.background",
            ...
            "背景",
            "Фон");
        Log("common.startup_command",
            "Startup commands",
            "启动命令",
            "啟動命令",
            "Команды запуска");
        Log("common.loop_command",
            "Loop command",
            "循环命令",
            "迴圈命令",
            "Команда цикла");
        ...
        Log("build_mode_save_loader.not_found_buildmode_save",
